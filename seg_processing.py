...
ct_itk = sitk.ReadImage("/vol/biomedic3/hjr119/XCAT/generation/HD_HEART_CT_1.nii.gz")
ct  = sitk.GetArrayFromImage(ct_itk)
seg = sitk.GetArrayFromImage(sitk.ReadImage("/vol/biomedic3/hjr119/XCAT/generation/HD_HEART_SEG_1.nii.gz"))
...
writer.SetFileName("/vol/biomedic3/hjr119/XCAT/generation/heart_seg_focus.nii.gz")
